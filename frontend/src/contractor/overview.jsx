...
//       .then(response => {
//         // Suppose response.data.projects contains the array
...
//             <List>
//               {projects.map(project => (
//                 <Link key={project._id} to={`/contractor/dashboard/${project._id}`} style={{ textDecoration: 'none' }}>
//                   <ListItem button>
//                   /contractor/dashboard/:contractorId/:projectId
//                     <ListItemAvatar>
//                       <Avatar>
//                         <FolderIcon />
//                       </Avatar>
